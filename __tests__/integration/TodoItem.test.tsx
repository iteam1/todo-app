...
describe('TodoItem — toggle', () => {
  it('checkbox is unchecked for active todo', () => {
    render(<TodoItemComponent todo={activeTodo} onToggle={jest.fn()} onDelete={jest.fn()} {...noopEditProps} />);
    const checkbox = screen.getByRole('checkbox');
    expect(checkbox).not.toBeChecked();
  });

  it('checkbox is checked for completed todo', () => {
    render(<TodoItemComponent todo={completedTodo} onToggle={jest.fn()} onDelete={jest.fn()} {...noopEditProps} />);
    const checkbox = screen.getByRole('checkbox');
  ...
  it('clicking checkbox calls onToggle with todo.id', async () => {
    ...
    render(<TodoItemComponent todo={activeTodo} onToggle={onToggle} onDelete={jest.fn()} {...noopEditProps} />);
...
describe('TodoItem — delete', () => {
  ...
  it('confirming delete calls onDelete with todo.id', async () => {
    ...
    render(<TodoItemComponent todo={activeTodo} onToggle={jest.fn()} onDelete={onDelete} {...noopEditProps} />);
    await userEvent.click(screen.getByRole('button', { name: /delete.*buy milk/i }));
